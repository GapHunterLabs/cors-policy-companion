# Privacy Policy — CORS Policy Companion

**Effective date:** 2026-08-24

CORS Policy Companion is a Gap Hunter Labs plugin for IntelliJ Platform
...
**Nothing.** CORS Policy Companion does not collect, store, transmit,
or sell any data — no source code, no file contents, no file paths, no
...
**None.** CORS Policy Companion makes zero network calls during normal
operation.

## Third parties

None. CORS Policy Companion has no third-party SDKs, no analytics
