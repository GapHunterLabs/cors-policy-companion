package dev.gaphunter.corspolicycompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.corspolicycompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.corspolicycompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "CORS Policy Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33791-cors-policy-companion/reviews"
